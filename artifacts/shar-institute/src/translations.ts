...
export const t = {
  // Nav
  navHome: { ku: 'سەرەکی', ar: 'الرئيسية', en: 'Home' },
  navCourses: { ku: 'کۆرسەکان', ar: 'الدورات', en: 'Courses' },
  ...
  regSubtitle: { ku: 'فۆرمەکە پڕ بکەرەوە و تیمی پەیمانگاکەمان پەیوەندیت پێوە دەکات', ar: 'أكمل النموذج وسيتواصل معك فريقنا', en: 'Fill out the form and our team will get in touch with you' },
  regName: { ku: 'ناوی تەواو', ar: 'الاسم الكامل', en: 'Full Name' },
  regPhone: { ku: 'ژمارەی تەلەفۆن', ar: 'رقم الهاتف', en: 'Phone Number' },
  regCourse: { ku: 'کۆرس هەڵبژێرە', ar: 'اختر الدورة', en: 'Select Course' },
  regShift: { ku: 'نۆبەت هەڵبژێرە', ar: 'اختر الوقت', en: 'Select Shift' },
  regShiftMorning: { ku: 'بەیانی', ar: 'صباحي', en: 'Morning' },
  regShiftEvening: { ku: 'ئێوارە', ar: 'مسائي', en: 'Evening' },
  regNotes: { ku: 'تێبینی (ئارەزوومەندانە)', ar: 'ملاحظات (اختياري)', en: 'Notes (optional)' },
  regSubmit: { ku: 'تۆماربکە', ar: 'إرسال', en: 'Submit Registration' },
  regSuccess: { ku: '! تۆمارکردنت بە سەرکەوتوویی تەواو بوو. بەم زووانە پەیوەندیت پێوە دەکرێت', ar: '! تم تسجيلك بنجاح. سنتواصل معك قريباً', en: 'Registration submitted successfully! We will contact you soon.' },
  regError: { ku: 'هەڵەیەک ڕوویدا. تکایە دووبارەی بکەرەوە', ar: 'حدث خطأ. يرجى المحاولة مرة أخرى', en: 'An error occurred. Please try again.' },
  regSelectCourse: { ku: '-- کۆرس هەڵبژێرە --', ar: '-- اختر الدورة --', en: '-- Select a Course --' },
  regSelectShift: { ku: '-- نۆبەت هەڵبژێرە --', ar: '-- اختر الوقت --', en: '-- Select a Shift --' },
